# Generated by Django 3.2.8 on 2022-06-29 19:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bio', models.TextField(default='Focusing on future', null=True)),
                ('backUpPasssword', models.CharField(max_length=2083, null=True)),
                ('followersPeople', models.IntegerField(blank=True, null=True)),
                ('avator', models.ImageField(default='userLogo.png', null=True, upload_to='')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=200)),
                ('Image_If_Needed', models.ImageField(default='defaultPost.jpg', null=True, upload_to='')),
                ('description', models.TextField(blank=True, max_length=2080, null=True)),
